...
function AlbumCard({ album, onClick, onDelete }) {
  ...
  return (
    <Card id="albumCard" css={cardCss} onClick={onClick}>
      <ImageIcon type="album" id={album.albumId} />
      <p className="spacingTop">{album.title}</p>
      <div css={artistOfAlbumCss}>
        <p>by</p>
